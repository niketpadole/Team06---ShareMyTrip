...
class PublisherRideDTOTest {
    ...
    void testToString() {
        ...
        String expectedString = "PublisherRideDTO(publisherRideId=1, publisherId=2, fromLocation=New York, toLocation=Boston, distance=300.5, journeyHours=4.5, availableSeats=3, reservedSeats=1, dateOfJourney=2023-06-22, timeOfJourney=10:00:00, farePerSeat=50.0, aboutRide=Comfortable ride with AC, timestamp=" + dto.getTimestamp() + ", status=NOT_COMPLETED, paymentStatus=PENDING)";
