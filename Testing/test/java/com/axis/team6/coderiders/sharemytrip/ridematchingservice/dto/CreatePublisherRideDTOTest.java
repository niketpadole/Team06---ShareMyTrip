...
class CreatePublisherRideDTOTest {
    ...
    void testToString() {
        ...
        String expectedString = "CreatePublisherRideDTO(publisherId=1, fromLocation=New York, toLocation=Boston, distance=300.5, journeyHours=4.5, availableSeats=3, dateOfJourney=2023-06-22, timeOfJourney=10:00:00, farePerSeat=50.0, aboutRide=Comfortable ride with AC, status=NOT_COMPLETED, paymentStatus=PENDING)";
