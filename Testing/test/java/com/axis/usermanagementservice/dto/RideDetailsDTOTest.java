...
class RideDetailsDTOTest {
    ...
    void getAndSetPassengerRideId() {
        RideDetailsDTO dto = new RideDetailsDTO();
        dto.setPassengerRideId(201);
        assertEquals(201, dto.getPassengerRideId());
    }
