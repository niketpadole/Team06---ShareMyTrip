...
<main className="py-10 bg-[#fff4f1]">
  <h1 className="text-4xl text-center text-red-600 mb-10">Admin Payments</h1>
    ...
    <table className="min-w-full bg-white">
      <thead>
        <tr>
          ...
          <th className="py-2 px-4 bg-gray-200">Publisher ID</th>
          <th className="py-2 px-4 bg-gray-200">Passenger ID</th>
      ...
      <tbody>
        <tr>
          ...
          <td className="border px-4 py-2">301</td>
          <td className="border px-4 py-2">Rs.50</td>
          <td className="border px-4 py-2">Rs.4.95</td>
