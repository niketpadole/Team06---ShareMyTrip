    ...
    <Layout>
      <main class="py-10 bg-[#fff4f1]">
        ...
        <section class="bg-white p-8 rounded-lg shadow-md max-w-4xl mx-auto">
          <h2 class="text-2xl text-red-600 mb-6">All Passengers</h2>
          <table class="min-w-full bg-white">
            ...
            <tbody>
              <tr>
                ...
                <td class="border px-4 py-2">sam.wilson@example.com</td>
                <td class="border px-4 py-2">1122334455</td>
